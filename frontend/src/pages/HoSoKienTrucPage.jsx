...
function EmptyState() {
  return (
    <div style={{ textAlign: 'center', padding: '4rem 0', color: 'var(--outline)' }}>
      <p style={{ fontSize: '15px' }}>Chưa có hồ sơ kiến trúc nào được xuất bản.</p>
    </div>
  )
}
...
/* ══════════════════════════════════════════════════════════════
   HoSoKienTrucPage
   ══════════════════════════════════════════════════════════════ */
export default function HoSoKienTrucPage() {
  ...
  const items = published('kien-truc')
    ...
    <div style={{ fontFamily: 'var(--font-body)' }}>
      <section style={{
        ...
        <p style={{
          ...
          Tổng hợp các hồ sơ thiết kế kiến trúc — bản vẽ mặt bằng, phối cảnh 3D và thuyết minh kỹ thuật cho từng công trình.
        </p>
